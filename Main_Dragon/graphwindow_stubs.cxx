...
/*
** WorkShop Visual Stub CloseGraphWindow
*/

/*
void CloseGraphWindow(Widget w, XtPointer client_data, XtPointer xt_call_data)
{
	XmPushButtonCallbackStruct *call_data = (XmPushButtonCallbackStruct *) xt_call_data ;
}
*/
/*
** WorkShop Visual Stub OpenGraphHelp
*/

void OpenGraphHelp(Widget w, XtPointer client_data, XtPointer xt_call_data)
{
	XmPushButtonCallbackStruct *call_data = (XmPushButtonCallbackStruct *) xt_call_data ;
...
/*
** WorkShop Visual Stub CallgraphListSelection
*/


/*
** WorkShop Visual Stub ControlflowListSelection
*/

void ControlflowListSelection(Widget w, XtPointer client_data, XtPointer xt_call_data)
{
